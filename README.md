...
![Status](https://img.shields.io/badge/Status-Concluído-success) ![IoT](https://img.shields.io/badge/IoT-ESP32%20%7C%20MQTT%20%7C%20NodeRED-blue) ![License](https://img.shields.io/badge/License-MIT-green)
...
![Dashboard](./img/dashboard_print.png)
*Visualização em tempo real das métricas de saúde e ambiente.*

### Circuito Eletrônico
![Circuito](./img/circuito_print.png)
*Esquema de montagem utilizando ESP32 e sensores.*
